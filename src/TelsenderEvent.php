...
TAG;
    ...
    {
        add_submenu_page('TelSender-Pro', 'TelSender events', 'Telsender event', 'manage_options', 'telsender-event', array($this, 'renderSettings'));
        add_submenu_page('telsender', 'TelSender events', 'Telsender event', 'manage_options', 'telsender-event', array($this, 'renderSettings'));
    }
